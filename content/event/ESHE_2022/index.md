...
![demo](/Talks/Eshe_2022/fig.2.jpg "**Fig. 2.** **(left)** Frequency of intra- and inter-layer connections sorted according to layer of provenience. Numbers within the bars refer to the sum of fragments within each category. **(right)** Quantification of the tested and connected (Conn.) fragments. Refit rates (Rate) are reported in percentages.")
...
![demo](/Talks/Eshe_2022/fig.5.jpg "**Fig. 5.** Spatial distribution of the inter-layer connections between A2 and the rest of the analyzed layers, as well as between A1 and D3d base. Light gray square meters correspond to the spatial distribution of the lower layers, while dark gray squares to those overlying. With A2 being extensively excavated, the spatial distribution of A2 inter-layer refits is quite homogeneous within the different excavated areas. The A2/A1 comparison is complemented by a rose chart on the orientation patterns.")
